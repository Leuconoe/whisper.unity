...
### 테스트 환경 (예상)
- 기기: Snapdragon 888 / Dimensity 9000
- 모델: whisper-tiny (39MB)
- 테스트: 5초 오디오 클립 추론
...
| 구성 | 추론 시간 | 향상률 |
|------|----------|--------|
| Original (기본) | 2000ms | 기준 |
| FUTO ggml | ~360ms | 5.6x |
| whisper175 (기본) | ~1600ms | 1.25x |
| whisper175 + flash_attn | ~1360ms | 1.5x |
| whisper175 + flash_attn + dynamic ctx | ~300-400ms | 5-6x |

**참고:** 이 수치는 FUTO 벤치마크와 whisper.cpp 릴리즈 노트 기반 추정치입니다.
실제 성능은 기기, 모델, 오디오 특성에 따라 달라집니다.
